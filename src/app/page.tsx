...
export default function Home() {
  return (
    <div className="h-screen bg-white from-blue-50 to-indigo-100 overflow-hidden">
      <div className="flex items-center justify-center h-full px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-6xl font-[Marble] text-gray-900 mb-6">
            Welcome to <span className="text-[#004aad]">Berry</span>
          </h1>
          <p className="text-xl font-[Marble] text-gray-600 mb-8 max-w-2xl mx-auto">
          ...
          <div className="flex gap-4 justify-center items-center flex-col sm:flex-row">
            <Link
              ...
              className="rounded-full border border-solid border-transparent transition-colors flex items-center justify-center bg-[#004aad] text-white gap-2 hover:bg-[#003a88] font-[Marble] text-sm sm:text-base h-12 px-8 sm:w-auto"
            >
              Student Sign Up
            </Link>
            <Link
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-8 max-w-2xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="text-[#004aad] mb-4">
                <svg className="w-8 h-8 mx-auto" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                </svg>
              </div>
              <h3 className="text-lg font-[Marble] text-gray-900 mb-2">For Students</h3>
              <p className="text-gray-600 text-sm">Access student resources, join organizations, and manage your academic life.</p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="text-[#f77fbe] mb-4">
                <svg className="w-8 h-8 mx-auto" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M4 4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2H4zm2 6a2 2 0 104 0 2 2 0 00-4 0zm6 0a2 2 0 104 0 2 2 0 00-4 0z" clipRule="evenodd" />
                </svg>
              </div>
              <h3 className="text-lg font-[Marble] text-gray-900 mb-2">For Organizations</h3>
              <p className="text-gray-600 text-sm mb-4">Manage your organization, track members, and coordinate activities.</p>
              <div className="space-y-2">
                <Link
                  href="/org/login"
                  className="inline-flex items-center text-sm font-[Marble] text-[#f77fbe] hover:text-green-500"
                >
                  Organization Sign In
          ...
          <div className="mt-8 text-sm font-[Marble] text-gray-500">
